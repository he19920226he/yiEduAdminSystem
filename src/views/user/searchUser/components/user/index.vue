  ...
  <div class="adminer">
    ...
    <el-dialog title="编辑管理员信息" :visible.sync="dialogFormVisible">
      <el-form :inline="true" :model="formUser" :rules="rules" ref="formUser" class="demo-form-inline">
        ...
        <el-form-item label="用户自我介绍" prop="tecintroduce" style="width:100%!important;">
          <el-input type="textarea" v-model="formUser.tecintroduce" style="width:270%!important;"></el-input>
        </el-form-item>
      </el-form>
  ...
  data () {
    ...
    return {
      ...
      rules: {
        ...
        stuage: [{ required: true, message: '请输入年龄', trigger: 'blur' }],
        // 性别选择:0男1女
